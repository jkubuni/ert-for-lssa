...
set nox2tics
set noy2tics
set title "Graph 4 (Results/Raspi/Run.001/FLOPS.002/OpenMP.0004)"
...
set output "Results/Raspi/Run.001/FLOPS.002/OpenMP.0004/graph4.ps"
plot "Results/Raspi/Run.001/FLOPS.002/OpenMP.0004/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
